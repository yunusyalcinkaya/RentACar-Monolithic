...
public class BrandManager implements BrandService {
    ...
    @Override
    @CacheEvict(value = "brand_list", allEntries = true) // veri eklendiğinde cache'e eklensin
    ...
    @Override
    @CacheEvict(value = "brand_list", allEntries = true) // veri güncellendiğinde cache'deki veri de güncellensin
    ...
    @Override
    @CacheEvict(value = "brand_list", allEntries = true) // veri silindiğinde cache'den de silinsin
